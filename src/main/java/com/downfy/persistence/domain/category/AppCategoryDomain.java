...
/*
 * AppCategoryDomain.java
 * 
 * App of category domain
 * 
 * Modification Logs:
 ...
 */
public class AppCategoryDomain implements DomainObject {

    public static final String OBJECT_KEY = ObjectKey.APP_CATEGORY;
