...
import com.downfy.form.application.AppDetailForm;
...
@Controller
public class BackedAppController extends AbstractController {

    private final Logger logger = LoggerFactory.getLogger(BackedAppController.class);
    @Autowired
