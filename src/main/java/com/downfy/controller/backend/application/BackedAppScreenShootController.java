...
@Controller
public class BackedAppScreenShootController extends AbstractController {

    private final Logger logger = LoggerFactory.getLogger(BackedAppScreenShootController.class);
    @Autowired
