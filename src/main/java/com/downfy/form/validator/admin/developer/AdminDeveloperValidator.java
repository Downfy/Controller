 ...
 */
package com.downfy.form.validator.admin.developer;
 ...
 */
@Service
public class AdminDeveloperValidator
        implements Validator {

    @Override
    public boolean supports(Class<?> clazz) {
        return AdminDeveloperValidator.class.equals(clazz);
    }

    @Override
    public void validate(Object target, Errors errors) {
        AdminCategoryDomain form = (AdminCategoryDomain) target;
